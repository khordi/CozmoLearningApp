...
def question1T(self: cozmo.robot.Robot):
    ...
    self.say_text("What do hypotenuse, opposite and adjacent ree fer too in a triangle?",voice_pitch=0,duration_scalar=0.6).wait_for_completed()
    return

def question2T(self: cozmo.robot.Robot):
   
    self.say_text("For Question 2, you must describe where you can find the term hypotenuse located on a triangle?", voice_pitch=0,duration_scalar=0.6).wait_for_completed()

    return

def question3T(self: cozmo.robot.Robot):
    
    self.say_text("For Question 3, you must describe where you can find the term opposite located on a triangle?", voice_pitch=0,duration_scalar=0.6).wait_for_completed()

    return

def question4T(self: cozmo.robot.Robot):
    
    self.say_text("For Question 4, you must describe where you can find the term adjacent located on a triangle?", voice_pitch=0,duration_scalar=0.6).wait_for_completed()
...
def question6T(self: cozmo.robot.Robot):
    ...
    self.say_text("For Question 6, What term is used to help you remember the trigonmetic ratios?", voice_pitch=0,duration_scalar=0.6).wait_for_completed()
...
def question7T(self: cozmo.robot.Robot):
    ...
    self.say_text("For Question 7, you must identify the expression used to work out sine", voice_pitch=0,duration_scalar=0.6).wait_for_completed()


    return

def question8T(self: cozmo.robot.Robot):
    self.say_text("For Question 8, you must identify the expression used to work out cosine", voice_pitch=0,duration_scalar=0.6).wait_for_completed()
...
def question9T(self: cozmo.robot.Robot):
    ...
    self.say_text("For Question 9, you must identify the expression used to work out tangent", voice_pitch=0,duration_scalar=0.6).wait_for_completed()
